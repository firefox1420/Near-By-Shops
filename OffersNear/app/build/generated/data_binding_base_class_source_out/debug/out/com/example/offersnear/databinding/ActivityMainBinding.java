...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnGoogle,
      @NonNull Button btnLogin, @NonNull TextView createNewaccount,
      @NonNull TextView forgotPassword, @NonNull EditText inputEmail,
      @NonNull EditText inputPassword, @NonNull TextView textView, @NonNull TextView textView4,
      @NonNull View view) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnGoogle, btnLogin,
          createNewaccount, forgotPassword, inputEmail, inputPassword, textView, textView4, view);
    }
